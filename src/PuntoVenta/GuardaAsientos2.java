...
public class GuardaAsientos2 implements Serializable {

    ArrayList<Asiento> ListRecuperada = new ArrayList<Asiento>();

    ArrayList<Asiento> leer() {
        try {
            ObjectInputStream in = new ObjectInputStream(new FileInputStream("Asiento2.dat"));
    ...
    void serializar(ArrayList<Asiento> ListaSeriar) {
        try {
            ...
            FileOutputStream out = new FileOutputStream("Asiento2.dat");
